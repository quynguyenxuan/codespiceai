...
export const blogPosts = [
  {
    ...
    description:
      "Learn how to build modern web applications with Next.js 14. We'll cover the new App Router, Server Components, and more.",
    date: 'May 20, 2025',
    readTime: '5 min read',
  ...
  },
  {
    ...
    description:
      'Discover how Tailwind CSS can streamline your styling workflow and help you build beautiful, responsive interfaces faster than ever.',
    date: 'May 15, 2025',
    readTime: '4 min read',
  ...
  },
  {
    ...
    description:
      'Best practices for creating accessible and inclusive user interfaces that work for everyone, regardless of ability or disability.',
    date: 'May 10, 2025',
    readTime: '7 min read',
  ...
  },
  {
    ...
    description:
      'Comparing different state management solutions for React apps including Context API, Redux, Zustand, and Jotai. Which one is right for your project?',
    date: 'May 5, 2025',
    readTime: '6 min read',
  ...
  },
  {
    ...
    description:
      'A comprehensive comparison of the two most popular cross-platform mobile development frameworks in 2025. Which one should you choose?',
    date: 'April 28, 2025',
    readTime: '8 min read',
  ...
  },
  {
    ...
    description:
      'Learn the basics of containerization with Docker and orchestration with Kubernetes to streamline your deployment process.',
    date: 'April 22, 2025',
    readTime: '9 min read',
  ...
  },
  {
    ...
    description:
      'Explore how to implement machine learning models directly in the browser using TensorFlow.js and other JavaScript libraries.',
    date: 'April 18, 2025',
    readTime: '7 min read',
  ...
  },
  {
    ...
    description:
      'Stay ahead of the curve with these emerging UI/UX design trends that are shaping the digital landscape in 2025.',
    date: 'April 12, 2025',
    readTime: '5 min read',
  ...
  },
  {
    ...
    description:
      'A step-by-step guide to setting up a continuous integration and deployment pipeline using GitHub Actions for your web projects.',
    date: 'April 8, 2025',
    readTime: '6 min read',
  ...
  },
  {
    ...
    description:
      'Advanced techniques to optimize your React applications for better performance and user experience.',
    date: 'April 3, 2025',
    readTime: '8 min read',
  ...
  },
  {
    ...
    description:
      "Understanding the fundamentals of Large Language Models (LLMs) and how they're transforming software development.",
    date: 'March 28, 2025',
  ...
  },
  {
    ...
    description:
      'Master CSS Grid to create complex, responsive layouts with less code and better maintainability.',
    date: 'March 22, 2025',
    readTime: '6 min read',
